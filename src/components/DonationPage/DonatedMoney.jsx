  ...
  return (
    <>
      <div className="card card-side bg-base-100 shadow-xl">
        <figure>
          <img className="h-full w-[220px] object-cover" src={img} alt="Movie" />
        </figure>
        <div style={{backgroundColor: card_bg}} className="card-body">
          ...
          <div>
             <button onClick={handleViewDetails} style={{backgroundColor: text_color}} className="px-5 py-2 text-white">View Details</button>
          </div>
        </div>
      </div>
    </>
